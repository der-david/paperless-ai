...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const processedTagsManager = new TagsManager('postProcessingTagToAddInput','postProcessingTagsToAddContainer','postProcessingTagsToAdd');
    const removeTagsManager = new TagsManager('postProcessingTagToRemoveInput','postProcessingTagsToRemoveContainer','postProcessingTagsToRemove');
